...
const chatBubbleVariants = cva(
  "group/message relative break-words rounded-lg p-3 text-sm sm:max-w-[70%]",
  {
    variants: {
      isUser: {
        true: "bg-zinc-800 text-zinc-100 border border-zinc-700/40 rounded-2xl rounded-tr-sm shadow-sm",
        false: "bg-zinc-900/50 border border-zinc-800/70 text-zinc-300 rounded-2xl rounded-tl-sm",
      },
      animation: {
        none: "",
